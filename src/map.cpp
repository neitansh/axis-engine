...
Map::Map(ICrateDef *cratedef):
	m_cratedef(cratedef),
	m_nodedef(cratedef->ndef())
{
}
...
void Map::setNode(v3s16 p, MapNode n)
{
	...
	v3s16 relpos = p - blockpos*MAP_BLOCKSIZE;
	set_node_in_block(m_cratedef->ndef(), block, relpos, n);
}
		...
		bool remove_metadata)
{
	...
	RollbackNode rollback_oldnode(this, p, m_cratedef);
	...
	{
		RollbackNode rollback_newnode(this, p, m_cratedef);
