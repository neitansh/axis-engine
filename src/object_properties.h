...
struct ObjectProperties
{
	...
	/*!
	 * Рисуется ли объект в общем пакете вместе с себе подобными.
	 *
	 * Мусор на поле боя — гильзы, крошка от взрывов, отметины — это сотни
	 * одинаковых мелочей. Каждая из них, будучи отдельным узлом сцены, стоит
	 * своей команды рисования: шестьсот гильз — шестьсот команд, и кадр
	 * ложится задолго до того, как поле выглядит обжитым.
	 *
	 * Помеченный так объект узла сцены не заводит вовсе. Его вершины ложатся
	 * в общий буфер к таким же — одна модель, одна текстура, один материал, —
	 * и вся россыпь рисуется одной командой. Экземпляр по-прежнему свой:
	 * своё место, свой поворот, свой свет, своя физика на сервере; общая у
	 * них только геометрия.
	 *
	 * Чего у такого объекта нет: скелетной анимации, привязок, таблички с
	 * именем и отметки на карте. Это цена, и она уместна ровно для того, ради
	 * чего всё затевалось, — для мусора, который лежит и красив.
	 */
	bool batched = false;
