...
-- Returns errors errors and a list of all enabled mods (inc. crate and world mods)
--
...
local function get_formspec(data)
	...
	if mod.is_modpack or mod.type == "crate" then
		...
		if info == "" then
			if mod.is_modpack then
				...
				info = fgettext("No crate description provided.")
			end
		end
		retval = retval ..
