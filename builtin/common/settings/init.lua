...
-- Uncomment to generate 'src/settings_translation_file.cpp'.
-- For RUN_IN_PLACE the generated file may appear in the 'bin' folder.
-- See comment and alternative line at the end of 'generate_from_settingtypes.lua'.
-- The example configuration is generated by util/generate_settings_domains.py.
